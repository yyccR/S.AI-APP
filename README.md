...
|                                               [ChatGPT](https://platform.openai.com/docs/api-reference/authentication)                                               | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                   [OpenAI Vision](https://platform.openai.com/docs/guides/vision)                                                    | `cloud model` | `cloud api` |        `视觉问答`<br/>`Visual Question Answering`         |
|                                                      [Moonshot](https://platform.moonshot.cn/docs/intro#文本生成模型)                                                      | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                     [Doubao](https://team.doubao.com/zh/?view_from=homepage_tab)                                                     | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                 [Doubao Vision](https://team.doubao.com/zh/?view_from=homepage_tab)                                                  | `cloud model` | `cloud api` |        `视觉问答`<br/>`Visual Question Answering`         |
|                                                                [DeepSeek](https://www.deepseek.com/)                                                                 | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                           [Gemini](https://ai.google.dev/gemini-api/docs)                                                            | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                         [Claude](https://docs.anthropic.com/en/api/overview)                                                         | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|   [Qwen](https://bailian.console.aliyun.com/console?tab=api#/api/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2833609.html&renderType=iframe)   | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
| [Wanx 2.1](https://bailian.console.aliyun.com/console?tab=api#/api/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2867393.html&renderType=iframe) | `cloud model` | `cloud api` |             `图像生成`<br/>`Image Generation`             |
|                                                    [智谱清言](https://docs.bigmodel.cn/cn/guide/start/model-overview)                                                    | `cloud model` | `cloud api` |             `文本生成`<br/>`Text Generation`              |
|                                                        [CosyVoice](https://github.com/FunAudioLLM/CosyVoice)                                                         | `cloud model` | `cloud api` |              `文字转语音`<br/>`Text To Speech`              |
|                                                       [Fish-Speech](https://github.com/fishaudio/fish-speech)                                                        | `cloud model` | `cloud api` |              `声音克隆`<br/>`Voice Cloning`               |
|                                                         [GPT-SoVITS](https://github.com/RVC-Boss/GPT-SoVITS)                                                         | `cloud model` | `cloud api` |              `声音克隆`<br/>`Voice Cloning`               |
|                                                   [LTX (ComfyUI)](https://github.com/Lightricks/ComfyUI-LTXVideo)                                                    | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                               [CogVideoX (ComfyUI)](https://github.com/kijai/ComfyUI-CogVideoXWrapper)                                               | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                                    [拍我AI](https://pai.video/home)                                                                    | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                                 [PixVerse](https://app.pixverse.ai/)                                                                 | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                  [Hailuo (MiniMax)](https://www.minimax.io/news/minimax-hailuo-02)                                                   | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                   [Kling](https://app.klingai.com/global/dev/document-api/quickStart/productIntroduction/overview)                                   | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                         [即梦](https://www.volcengine.com/docs/85621/1544716)                                                          | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                         [Vidu](https://platform.vidu.com/docs/introduction)                                                          | `cloud model` | `cloud api` |             `视频生成`<br/>`Video Generation`             |
|                                                    [Volcengine STT](https://www.volcengine.com/docs/6561/163032)                                                     | `cloud model` | `cloud api` |         `音频识别`<br/>`Auto Speech Recognition`          |
|                                 [Azure STT](https://learn.microsoft.com/zh-tw/azure/ai-services/speech-service/index-speech-to-text)                                 | `cloud model` | `cloud api` |         `音频识别`<br/>`Auto Speech Recognition`          |
|                                                    [Volcengine TTS](https://www.volcengine.com/docs/6561/163032)                                                     | `cloud model` | `cloud api` |              `文字转语音`<br/>`Text To Speech`              |
|        [Azure TTS](https://learn.microsoft.com/zh-cn/azure/ai-services/speech-service/get-started-text-to-speech?tabs=macos&pivots=programming-language-rest)        | `cloud model` | `cloud api` |              `文字转语音`<br/>`Text To Speech`              |
|                                                    [Volcengine OCR](https://www.volcengine.com/docs/6790/117730)                                                     | `cloud model` | `cloud api` |      `光学字符识别`<br/>`OCR`       |
|                                                  [Volcengine Translate](https://www.volcengine.com/docs/4640/65067)                                                  | `cloud model` | `cloud api` |           `机器翻译`<br/>`Machine Translation`            |
|                                           [Qwen-MT Translate](https://help.aliyun.com/zh/model-studio/machine-translation)                                           | `cloud model` | `cloud api` |           `机器翻译`<br/>`Machine Translation`            |
|                                     [Qwen Image Edit](https://bailian.console.aliyun.com/?tab=api#/api/?type=model&url=2976416)                                      | `cloud model` | `cloud api` |                `图像编辑`<br/>`Image Edit`                |
|                                     [Qwen Image Erase](https://bailian.console.aliyun.com/?tab=api#/api/?type=model&url=2840907)                                     | `cloud model` | `cloud api` |             `图像修复`<br/>`Image Inpainting`             |
|                                              [Nano Banana](https://ai.google.dev/gemini-api/docs/image-generation#rest)                                              | `cloud model` | `cloud api` |             `图像生成`<br/>`Image Generation`             |
